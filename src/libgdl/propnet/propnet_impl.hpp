...
inline void PropNet::CrystalUpdate_input(const AMove& move, AMove& base, AState& top, size_t* m_set_size, size_t* goals, signed short* data, unsigned short* n_stack, signed short* v_stack) const
{
...
inline void PropNet::CrystalUpdate_base(const AState& state, AState& base, AState& top, size_t* m_set_size, size_t* goals, signed short* data, unsigned short* n_stack, signed short* v_stack) const
{
  //std::stack<size_t, std::deque<size_t>> n_stack;
  //std::stack<signed short, std::deque<size_t>> v_stack;
