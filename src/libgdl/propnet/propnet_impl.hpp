...
inline void PropNet::CrystalUpdate_input(const AMove& move, AMove& base, AState& top, std::set<size_t>* m_set, size_t* goals, signed short* data, size_t* n_stack, signed short* v_stack) const
{
...
inline void PropNet::CrystalUpdate_base(const AState& state, AState& base, AState& top, std::set<size_t>* m_set, size_t* goals, signed short* data, size_t* n_stack, signed short* v_stack) const
{
  //std::stack<size_t, std::deque<size_t>> n_stack;
  //std::stack<signed short, std::deque<size_t>> v_stack;
...
inline void PropNet::UpdateNormal_base(const AState& state, AState& base, AState& top, std::set<size_t>* m_set, size_t* goals) const
{
  AMove m;
  for(size_t i = 0;i < state.get()->arr_size;i++)
  {
...
inline void PropNet::UpdateNormal_input(const AMove& move, AState& base, AState& top, AMove& m, std::set<size_t>* m_set, size_t* goals) const
{
  for(size_t i = 0;i < move.get()->n_roles;i++)
  {
