...
int main(int argc, char* argv[])
{
  ...
  {
    std::cout << "ERROR: Output file has to be mentioned." << std::endl;
    std::cout << "USAGE : flatten OUTPUT_FILE -c SOURCE_FILES" << std::endl;
    return 1;
  }
  ...
  {
    std::cout << "ERROR: at least one source file has to be mentioned." << std::endl;
    std::cout << "USAGE : flatten OUTPUT_FILE -c SOURCE_FILES" << std::endl;
    return 1;
  }
  ...
  KIF kif(warn, 1, Log(std::cerr, false, false));
