 ...
 */
#ifndef _LIBGDL_GDLPARSER_PARSER_CLAUSE_HPP_INCLUDED
#define _LIBGDL_GDLPARSER_PARSER_CLAUSE_HPP_INCLUDED
...
inline std::ostream& operator<<(std::ostream& o,
                                const gdlparser::parser::Clause& clause)
{
  o << "(<= ";
  o << *clause.head << " ";
...
#endif // _LIBGDL_GDLPARSER_PARSER_CLAUSE_HPP_INCLUDED
