 ...
 */
#ifndef _LIBGDL_GDLPARSER_PARSER_DGRAPH_NODE_HPP_INCLUDED
#define _LIBGDL_GDLPARSER_PARSER_DGRAPH_NODE_HPP_INCLUDED
...
#endif // _LIBGDL_GDLPARSER_PARSER_DGRAPH_NODE_HPP_INCLUDED
